...
import { logIn } from "@/auth/Reducer.ts";
...
// Google Client ID - đặt trong .env
const GGLE_CLIENT_ID = import.meta.env.VITE_GOOGLE_CLIENT_ID || '';
...
const AuthPage = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const msgs: string[] = err.errors || ['Login failed. Please try again.'];
            setError(msgs);
        } finally {
            setLoading(false);
        }
    ...
    const handleGoogleSuccess = async (credentialResponse: any) => {
        ...
        try {
            ...
            const msgs: string[] = err.errors || ['Google login failed. Please try again.'];
            setError(msgs);
        } finally {
        ...
        <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
            {googleLoading ? (
                ...
                >
                    ...
                    <Typography sx={{ fontSize: '0.9rem', color: t.n600 }}>
    ...
    /* ══════════════════════════════════════════════════
       ...
       ══════════════════════════════════════════════════ */
    return (
        <GoogleOAuthProvider clientId={GGLE_CLIENT_ID}>
            <Box
                sx={{
                    minHeight: '100vh',
                    display: 'flex',
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography sx={{ color: t.n500, fontSize: '0.88rem', mb: 2.5 }}>
