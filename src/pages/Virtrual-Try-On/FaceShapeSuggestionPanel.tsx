...
export const FaceShapeSuggestionPanel = ({ result, isAnalyzing = false }: Props) => {
    ...
    return (
        <Box sx={{
            ...
            {result && visible && (
                <Box>
                    {/* ── Header: shape + confidence ── */}
                    <Box sx={{
                        px: 2, py: 2,
                        borderBottom: `1px solid ${BORDER}`,
                        display: "flex", alignItems: "center", gap: 2,
                    }}>
                        {/* Shape icon in teal circle */}
                        <Box sx={{
                        ...
                        <Box sx={{ flex: 1 }}>
                            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 0.3 }}>
                                <Typography sx={{
                                    ...
                                    fontWeight: 700, fontSize: "1.1rem", color: TEXT,
                                }}>
                                    {result.label} Face
                                </Typography>
                                <Box sx={{
                                    px: 1, py: 0.2,
                                    bgcolor: TEAL_LIGHT, border: `1px solid ${TEAL_BORDER}`,
                                    borderRadius: "20px",
                                }}>
                    ...
                    <Box sx={{ px: 2, py: 1.5 }}>
                        <Typography sx={{
                            fontFamily: fontSans, fontSize: "0.65rem", fontWeight: 600,
                            textTransform: "uppercase", letterSpacing: "0.1em",
                            color: TEXT_MUTED, mb: 1.2,
                        }}>
                            Recommended Styles
                        </Typography>
                                    ...
                                    <Box sx={{ flex: 1, minWidth: 0 }}>
                                        <Box sx={{ display: "flex", alignItems: "center", gap: 0.8, mb: 0.2 }}>
                                            {i === 0 && (
                                                <Box sx={{
                                                    px: 0.8, py: 0.15,
                                                    bgcolor: TEAL, borderRadius: "20px",
                                                    flexShrink: 0,
                                                }}>
                                        ...
                                        <Typography sx={{
                                            ...
                                            color: TEXT_MUTED, lineHeight: 1.4,
                                        }}>
                                            {rec.reason}
                                        </Typography>
                                    </Box>
