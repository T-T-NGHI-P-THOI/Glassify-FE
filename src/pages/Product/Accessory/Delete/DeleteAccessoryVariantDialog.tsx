...
interface DeleteAccessoryVariantDialogProps {
    open: boolean;
    onClose: () => void;
    onConfirm?: () => void;
    variantId?: string;
...
const DeleteAccessoryVariantDialog = ({
    open,
    onClose,
    onConfirm,
    variantId,
    ...
    variantSize,
    colorName
}: DeleteAccessoryVariantDialogProps) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            await ProductAPI.deleteAccessoryVariant(variantId);
    ...
    const variantName = `${accessoryName} - ${variantSize} - ${colorName}`;
...
export default DeleteAccessoryVariantDialog;